...
import { DollarSign, TrendingUp, TrendingDown, Scale, AlertTriangle, CheckCircle } from "lucide-react";
...
const FinanceiroDashboard: React.FC = () => {
  const { summary, loading, contasPagar, contasReceber, movimentacoes } = useFinanceiro();
  const { user } = useAuth();
