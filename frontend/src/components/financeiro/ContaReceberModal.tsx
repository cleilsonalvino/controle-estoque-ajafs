// src/components/financeiro/ContaReceberModal.tsx
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export const ContaReceberModal = ({ children, open, onOpenChange }: ContaReceberModalProps) => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    console.log(values);
    // Here you would call the API to save the conta a receber
    onOpenChange?.(false);
  }
